    ...
    return(
      ...
      <div className="felx items-start gap-7">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 p-5 border border-gray-400 rounded">
            <Avatar size="small" src="/images/img.png" alt="Phto de licoln"/>
            <Avatar src="/images/ma_photo.jpg" alt="ma photo"/>
            <Avatar size="large" src="/images/photo_yac.jpg" alt="ma photo"/>
           </div>
       </div>
